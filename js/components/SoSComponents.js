                    ...
                    <div className="absolute bottom-24 left-4 right-4 z-[1000] bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-red-100 p-5 flex flex-col gap-3 transition-all duration-300 pointer-events-auto">
                        ...
                        <div className="flex gap-2 mt-1">
                            ...
                            <button
                                    ...
                                    if (navigator.share) {
                                        try {
                                            await navigator.share({
                                                title: `SOS Khẩn Cấp: ${selectedSOS.name}`,
                                                text: `Hỗ trợ cứu hộ khẩn cấp cho ${selectedSOS.name}: "${selectedSOS.message}"`,
                                                url: shareUrl
                                            });
                                        } catch (err) {
                                ...
                                className="flex-1 py-3 bg-stone-750 text-white rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-stone-850 active:scale-95 shadow-md shadow-stone-500/20 transition-all cursor-pointer"
                            >
